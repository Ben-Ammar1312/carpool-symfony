 ...
 */
final class Version20241110172303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD type VARCHAR(255) NOT NULL, CHANGE string email VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD string VARCHAR(255) NOT NULL, DROP email, DROP type');
    }
}
